  ...
  <body>
    <main>
      ...
      <section>
        ...
        ${anonymized ? `<p class="muted">${uiLocalizationService.sourceHtml("Terminology text is omitted from this anonymized report. Counts are preserved in Resources.")}</p>` : data.terms.length ? `<table>
      ...
      <section>
        ...
        ])}</tbody></table>` : `<p class="muted">${uiLocalizationService.sourceHtml("No activity recorded.")}</p>`}
      </section>
      <footer>
  ...
  <body>
    <main>
      ...
      <section>
        ...
        </table>` : `<p class="muted">${uiLocalizationService.sourceHtml("No unresolved quality risks.")}</p>`}
      </section>
      <section>
