...
The capture uses a deterministic project and produces projects empty/populated, project dashboard, translation editor, new-project dialog, AI Command Centre, responsive/laptop editor checkpoints, Focus mode, and command palette images at 1440×900, 1366×768, and 1024×768. `baseline.json` records runtime versions, asset composition, startup sample, input-dispatch sample, scroll-frame sample, keyboard paths, and known accessibility exceptions.
