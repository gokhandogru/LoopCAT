...
const projectDialogSaveControllerPath = path.join(
  ...
  "features",
  "projects",
  "project-dialog-save-controller.js"
);
const projectDocumentImportControllerPath = path.join(
  root,
  "src",
  "features",
  "import-export",
...
const revisionHistoryPresentationServicePath = path.join(
  ...
  "features",
  "quality",
  "revision-history-presentation-service.js"
);
...
const segmentActionButtonsControllerPath = path.join(
  ...
  "features",
  "editor",
  "segment-action-buttons-controller.js"
);
...
function main() {
  ...
  extractScript(
    messagesByText,
    applicationStorageDurabilityControllerPath,
  ...
  extractScript(
    messagesByText,
    projectsViewPresentationControllerPath,
  ...
  extractScript(
    messagesByText,
    segmentProgressPresentationServicePath,
  ...
  extractScript(
    messagesByText,
    segmentStatusPresentationServicePath,
  ...
  extractScript(
    messagesByText,
    projectDialogSaveControllerPath,
