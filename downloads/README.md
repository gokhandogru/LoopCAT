# LoopCAT 0.0.4-dev.20260924 Downloads

This is an **unsigned development preview**, not a signed or production-qualified release.

Build: `0.0.4-dev.20260924+source.0763d7578732`

Base commit: `89f2b9947e84d664bf07614124be2da8fce3aa22`

Source snapshot SHA-256: `0763d7578732b6f6b669941a2b4d8018f26e3793202f07f4c104a15d511005ac`
...
| Download | File |
| --- | --- |
| Web application | [`LoopCAT.Web.0.0.4-dev.20260924.zip`](./LoopCAT.Web.0.0.4-dev.20260924.zip) |
| Windows installer | [`LoopCAT.Windows.Setup.0.0.4-dev.20260924.zip`](./LoopCAT.Windows.Setup.0.0.4-dev.20260924.zip) |
| Windows portable application | [`LoopCAT.0.0.4-dev.20260924.Portable.zip`](./LoopCAT.0.0.4-dev.20260924.Portable.zip) |
| SHA-256 checksums | [`LoopCAT.0.0.4-dev.20260924.SHA256SUMS.txt`](./LoopCAT.0.0.4-dev.20260924.SHA256SUMS.txt) |
